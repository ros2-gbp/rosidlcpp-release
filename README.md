## rosidlcpp (jazzy) - 0.5.0-1

The packages in the `rosidlcpp` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy rosidlcpp` on `Mon, 26 Jan 2026 21:15:36 -0000`
...
## rosidlcpp (kilted) - 0.5.0-1

The packages in the `rosidlcpp` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted rosidlcpp` on `Mon, 26 Jan 2026 21:12:28 -0000`
...
## rosidlcpp (rolling) - 0.5.0-1

The packages in the `rosidlcpp` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling rosidlcpp` on `Mon, 26 Jan 2026 21:09:21 -0000`
...
## rosidlcpp (jazzy) - 0.4.0-1

The packages in the `rosidlcpp` repository were released into the `jazzy` distro by running `/usr/bin/bloom-release --rosdistro jazzy rosidlcpp` on `Sun, 07 Sep 2025 17:10:58 -0000`
...
## rosidlcpp (kilted) - 0.4.0-1

The packages in the `rosidlcpp` repository were released into the `kilted` distro by running `/usr/bin/bloom-release --rosdistro kilted rosidlcpp` on `Sun, 07 Sep 2025 16:59:44 -0000`
...
## rosidlcpp (rolling) - 0.4.0-1

The packages in the `rosidlcpp` repository were released into the `rolling` distro by running `/usr/bin/bloom-release --rosdistro rolling rosidlcpp` on `Sun, 07 Sep 2025 16:56:22 -0000`
